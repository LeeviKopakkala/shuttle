...
passport_1.default.use(new LocalStrategy({ usernameField: 'username' }, function (username, password, done) { return __awaiter(void 0, void 0, void 0, function () {
    var usernameString;
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, done(undefined, false, { message: 'invalid username or password' })];
    });
}); }));
